...
MACRO_CONFIG = {
    ...
    "DGS1MO":     ("DGS1MO", None),  # 1-month
    "DGS3MO":     ("DGS3MO", None),  # 3-month
    "DGS6MO":     ("DGS6MO", None),  # 6-month
    "DGS1":       ("DGS1", None),    # 1-year
    "DGS2":       ("DGS2", None),    # 2-year
    "DGS5":       ("DGS5", None),    # 5-year
    "DGS7":       ("DGS7", None),    # 7-year
    "DGS10":      ("DGS10", None),   # 10-year
    "DGS20":      ("DGS20", None),   # 20-year
    "DGS30":      ("DGS30", None),   # 30-year
