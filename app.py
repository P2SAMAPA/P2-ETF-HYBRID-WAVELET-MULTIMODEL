...
EQUITIES       = ["QQQ", "XLK", "XLF", "XLE", "XLV", "XLI", "XLY", "XLP", "XLU", "XME", "GDX", "IWM", "IWD", "SOXX", "SMH", "URA", "XSD", "XBI", "XLRE", "IWF", "IWO"]
BENCHMARKS     = ["SPY", "AGG"]
...
def run_professional_backtest(raw_df, start_yr, model_choice, t_costs_bps, stop_loss_pct,
    ...
    # HARD-CODED: Feature counts matching what the models were trained with
    if cat_prefix == "fi_commodities":
